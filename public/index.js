...
const drawFive = () => {
    axios.get('http://127.0.0.1:3000/api/robots/five')
        .then(res => {
...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://127.0.0.1:3000/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://127.0.0.1:3000/api/player')
...
const getAllBots = () => {
    axios.get('http://127.0.0.1:3000/api/robots')
        .then(({data}) => {
